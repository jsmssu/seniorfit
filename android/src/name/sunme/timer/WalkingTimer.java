...
public class WalkingTimer {
	static String TAG = "WalkingTimer";
	public static Context context;
	public static boolean threadstopped = true;
	public static String db_str_walking = "wkt_";
	...
	public static String getKey(Date date) {
		return db_str_walking + dbformat.format(date);
	}
	public static String getKey(Calendar date) {
		return db_str_walking + dbformat.format(date.getTime());
	}
